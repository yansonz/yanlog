...
- 8개 feature 구현, MVP 수준 프로덕션 런칭 (클로즈 베타)
  ...
  - (2026.07.01) Amazon SES Production Access 처리 며칠째 안해줘서 [resend](https://resend.com/)로 대체함
- 3개 언어 지원 (한/영/일)
- AWS 인프라 전체 CDK 관리
